...
<p class="wrap-header">
    <a class="view-demo" href="http://royal.webulous.in">
        <i class="fa fa-eye"></i> $view_demo</a> 
    <a class="upgrade" href="http://www.webulousthemes.com/?add-to-cart=1596">
...
function royal_theme_page() {
    add_theme_page( 
        __( 'Upgrade To Royal Pro','royal'),
        __( 'Theme Upgrade','royal'),
        'edit_theme_options',
        'royal_upgrade',
...
function royal_display_upgrade() {
    ...
    $options = array(
        ...
        'panels' => array(
            'royal' => array(
                'priority'       => 9,
                'title'          => __('Royal Options', 'royal'),
                'description'    => __('Royal Theme Options', 'royal'),
                'sections' => array(
                    'general' => array(
                        'title' => __('General', 'royal'),
                        'description' => __('General settings that affects overall site', 'royal'),
                        'fields' => array(
                            'breadcrumb' => array(
                                'type' => 'checkbox',
                                'label' => __('Enable Breadcrumb', 'royal'),
                                'default' => 0,
                                'sanitize_callback' => 'royal_boolean',
                            ),
                            'breadcrumb_char' => array(
                                'type' => 'select',
                                'label' => __('Select Breadcrumb Character', 'royal'),
                                'choices' => array(
                                    '1' => ' &raquo; ',
                                    '2' => ' / ',
                                    '3' => ' > '      
                                ),
                                'sanitize_callback' => 'royal_breadcrumb_char_choices',
                                'default' => '1',
                            ),
                        ),
                    ),
                    'header' => array(
                        ...
                        'fields' => array(
                            'logo_title' => array(
                                'type' => 'checkbox',
                                'label' => __('Logo as Title', 'royal'),
                                'default' => 0,
                                'sanitize_callback' => 'royal_boolean',
                            ),
                            'logo' => array(
                                'type' => 'image',
                                'label' => __('Upload Logo', 'royal'),
                    ...
                    'home' => array(
                        ...
                        'fields' => array(
                            ...
                            'service_1' => array(
                                'type' => 'dropdown-pages',
                                'label' => __('Service Section #1', 'royal'),
                                'sanitize_callback' => 'absint',
                            ),
                            'service_2' => array(
                                'type' => 'dropdown-pages',
                                'label' => __('Service Section #2', 'royal'),
                                'sanitize_callback' => 'absint',
                            ),
                            'service_3' => array(
                                'type' => 'dropdown-pages',
                                'label' => __('Service Section #3', 'royal'),
                                'sanitize_callback' => 'absint',
                            ),
...
function royal_breadcrumb_char_choices($value='') {
    $choices = array('1','2','3');
