<?php
	...
	class Wbls_Customizer_API_Wrapper {
		...
		public function enqueue_scripts() {
			...
			wp_localize_script( 'customizer-js', 'royal_upgrade', array( 'message' => __( 'Get Pro for just $39', 'royal' ), 'docs' => __( 'Documentation', 'royal' ), 'demo' => __( 'Demo', 'royal' ), 'support' => __( 'Ask a Question', 'royal' ) ) );
		}
